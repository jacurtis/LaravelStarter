<template>
  <div class="p-6 bg-brave-boulder min-h-screen flex justify-center items-center">
    <flash-messages></flash-messages>
    <div class="w-full max-w-sm">
      <logo class="block mx-auto w-full max-w-xs fill-white" name="light" height="75px"/>
      <form class="mt-5 bg-white rounded-lg shadow-lg overflow-hidden" @submit.prevent="submit">
        <div class="px-10 py-12">
          <h1 class="text-center font-bold text-brave-graphite text-3xl">Welcome Back!</h1>

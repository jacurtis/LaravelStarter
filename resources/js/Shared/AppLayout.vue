  ...
  <div>
    ...
    <div class="flex flex-col">
      <div class="h-screen flex flex-col" @click="hideDropdownMenus">
        <div class="md:flex">
          <div class="bg-brave-graphite md:flex-no-shrink md:w-56 py-4 flex items-center justify-between md:justify-center">
            <inertia-link class="mt-1" href="/">
              <logo class="fill-white" width="120" height="28" />
            </inertia-link>
            <dropdown class="md:hidden" placement="bottom-end">
              <svg class="fill-white w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" /></svg>
              <div slot="dropdown" class="mt-2 px-8 py-8 shadow-lg bg-indigo-darker rounded">
                <main-menu :url="url()" />
              </div>
            </dropdown>
          </div>
          <div class="bg-white border-b w-full p-4 md:py-0 md:px-12 text-sm md:text-base flex justify-between items-center">
            ...
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <div slot="dropdown" class="mt-2 py-2 shadow-lg bg-white rounded text-sm">
                <inertia-link :href="route('users')" class="block px-6 py-2 hover:bg-indigo hover:text-white" >My Profile</inertia-link>
                <inertia-link :href="route('users')" class="block px-6 py-2 hover:bg-indigo hover:text-white" >Manage Users</inertia-link>
        ...
        <div class="flex flex-grow overflow-hidden">
          <main-menu :url="url()" class="bg-brave-boulder flex-no-shrink py-5 w-56 hidden md:block overflow-y-auto" />
